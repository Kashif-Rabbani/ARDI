...
import com.genesis.eso.util.JSONUtil;
import com.genesis.eso.util.NewRDFUtil;
import com.genesis.eso.util.TempFiles;
import com.genesis.rdf.model.bdi_ontology.metamodel.NewSourceLevel2;
import com.genesis.rdf.parsers.JSONAdapter;
...
public class JsonSchemaExtractor {
    ...
    static {
        try {
            ...
            String path = JsonSchemaExtractor.class.getClassLoader().getResource("model/new_metadata_model2.owl").getPath();
